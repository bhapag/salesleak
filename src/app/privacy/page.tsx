...
const DESCRIPTION = "SalesLeak's Privacy Policy — currently being finalized.";
      ...
      <main className="mx-auto max-w-3xl px-6 py-16 sm:px-8">
        ...
        <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-5">
          ...
          <p className="mt-2 text-sm leading-relaxed text-amber-700">
            SalesLeak&apos;s Privacy Policy is still being finalized and hasn&apos;t been reviewed and published. Nothing on
            this page should be treated as a binding privacy commitment — there isn&apos;t one here yet. We&apos;d rather
            tell you that plainly than publish something that only looks like a real privacy policy.
          </p>
        </div>

        <p className="mt-8 text-sm leading-relaxed text-slate-600">
          If you have a question about how SalesLeak handles data — including anything you&apos;d normally expect a
          privacy policy to cover — reach out and we&apos;ll answer directly:
        </p>
        <p className="mt-3">
